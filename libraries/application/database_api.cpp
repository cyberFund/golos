...
*/
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        ...
                        select<tags::tag_object,tags::by_mode_parent_children_rshares2,true>(
                                query.select_tags,
                                query,
                                parent,
                                tidx,
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        const auto &tidx_ = my->_db.get_index<languages::language_index>().indices().get<languages::by_mode_parent_children_rshares2>();

                        std::multimap<languages::language_object, discussion,languages::by_mode_parent_children_rshares2> map_result_;

                       select<languages::language_object,languages::by_mode_parent_children_rshares2,false>(
        ...
        std::vector<discussion> database_api::get_discussions_by_promoted(const discussion_query &query) const {
            return my->_db.with_read_lock([&]() {
                ...
                select<tags::tag_object,tags::by_parent_promoted,true>(
                        query.select_tags,
                        query,
                        parent,
                        tidx,
        ...
        std::vector<discussion> database_api::get_discussions_by_created(const discussion_query &query) const {
            return my->_db.with_read_lock([&]() {
                ...
                select<tags::tag_object,tags::by_parent_created,true>(
                        query.select_tags,
                        query,
                        parent,
                        tidx,
        ...
        std::vector<discussion> database_api::get_discussions_by_active(const discussion_query &query) const {
            return my->_db.with_read_lock([&]() {
                ...
                select<tags::tag_object,tags::by_parent_active,true>(
                        query.select_tags,
                        query,
                                parent,
                        tidx,
        ...
        std::vector<discussion> database_api::get_discussions_by_cashout(const discussion_query &query) const {
            return my->_db.with_read_lock([&]() {
                ...
                select<tags::tag_object,tags::by_cashout,true>(
                        query.select_tags,
                        query,
                                parent,
                        tidx,
        ...
        std::vector<discussion> database_api::get_discussions_by_payout(const discussion_query &query) const {
            return my->_db.with_read_lock([&]() {
                ...
                select<tags::tag_object,tags::by_net_rshares,true>(
                        query.select_tags,
                        query,
                        parent,
                        tidx,
        ...
        std::vector<discussion> database_api::get_discussions_by_votes(const discussion_query &query) const {
            return my->_db.with_read_lock([&]() {
                ...
                select<tags::tag_object,tags::by_parent_net_votes,true>(
                        query.select_tags,
                        query,
                        parent,
                        tidx,
        ...
        std::vector<discussion> database_api::get_discussions_by_children(const discussion_query &query) const {
            return my->_db.with_read_lock([&]() {
                ...
                select<tags::tag_object,tags::by_parent_children,true>(
                        query.select_tags,
                        query,
                                parent,
                        tidx,
        ...
        std::vector<discussion> database_api::get_discussions_by_hot(const discussion_query &query) const {
            ...
            return my->_db.with_read_lock([&]() {
                ...
                select<tags::tag_object,tags::by_parent_hot,true>(
                        query.select_tags,
                        query,
                        parent,
                        tidx,
