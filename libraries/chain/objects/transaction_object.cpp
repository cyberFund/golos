...
namespace golos {
    namespace chain {
        ...
        const object *transaction_index::create(const std::function<void(object *)> &constructor, object_id_type) {
            ...
            FC_ASSERT(result.second,
                      "Could not create transaction_object! Most likely a uniqueness constraint is violated.");
            return &*result.first;
        }
        ...
        void transaction_index::modify(const object *obj, const std::function<void(object *)> &m) {
            ...
            _index.modify(itr, [&m](transaction_object &o) {
                m(&o);
            });
        }
        ...
        void transaction_index::add(unique_ptr <object> o) {
            ...
            FC_ASSERT(result.second,
                      "Could not insert transaction_object! Most likely a uniqueness constraint is violated.");
        }
