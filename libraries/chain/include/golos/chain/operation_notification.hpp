...
namespace golos {
    namespace chain {
         ...
         *
         * Operation notification context is required to induce @ref boost::signal2 notifications for connected @ref plugin slots. Operation notification context passes the operation coming in @ref database from chain internals to plugin interfaces.
         */
