...
namespace steemit {
    namespace chain {
        ...
        class subscribe_by_author_evaluator
                : public evaluator<subscribe_by_author_evaluator> {
        public:
        ...
        class automatic_renewal_of_subscription_evaluator
                : public evaluator<automatic_renewal_of_subscription_evaluator> {
        public:
        ...
        class disallow_automatic_renewal_of_subscription_evaluator
                : public evaluator<disallow_automatic_renewal_of_subscription_evaluator> {
        public:
        ...
        class renewal_of_subscription_evaluator
                : public evaluator<renewal_of_subscription_evaluator> {
        public:
