...
#pragma GCC diagnostic ignored "-Wall"
            ...
            namespace operations {
                template<uint8_t Major, uint8_t Hardfork, uint16_t Release, uint32_t IncrementalCode = 0,
                        ...
                        4040000 + 100 * steemit::protocol::operation::tag<
                                steemit::protocol::transfer_operation<Major, Hardfork, Release>>::value +
                        IncrementalCode, What>;

                template<uint8_t Major, uint8_t Hardfork, uint16_t Release, uint32_t IncrementalCode = 0,
                        typename What = boost::mpl::string<
                                'transfer_operation evaluation exception'>> using transfer_evaluate_exception = chain::operation_evaluate<
                        4050000 + 100 * steemit::protocol::operation::tag<
                                steemit::protocol::transfer_operation<Major, Hardfork, Release>>::value +
                        IncrementalCode, What>;
                ...
                template<uint8_t Major, uint8_t Hardfork, uint16_t Release, uint32_t IncrementalCode = 0,
                        ...
                        4040000 + 100 * steemit::protocol::operation::tag<
                                steemit::protocol::account_create_operation<Major, Hardfork, Release>>::value +
                        IncrementalCode, What>;
                ...
                template<uint8_t Major, uint8_t Hardfork, uint16_t Release, uint32_t IncrementalCode = 0,
                        ...
                        4040000 + 100 * steemit::protocol::operation::tag<
                                steemit::protocol::account_update_operation<Major, Hardfork, Release>>::value +
                        IncrementalCode, What>;
            ...
            namespace operations {
                template<uint8_t Major, uint8_t Hardfork, uint16_t Release, uint32_t IncrementalCode = 0,
                        ...
                        4040000 + 100 * steemit::protocol::operation::tag<
                                steemit::protocol::proposal_create_operation<Major, Hardfork, Release>>::value +
                        IncrementalCode, What>;
                ...
                template<uint8_t Major, uint8_t Hardfork, uint16_t Release, uint32_t IncrementalCode = 0,
                        ...
                        4040000 + 100 * steemit::protocol::operation::tag<
                                steemit::protocol::asset_reserve_operation<Major, Hardfork, Release>>::value +
                        IncrementalCode, What>;
                ...
                template<uint8_t Major, uint8_t Hardfork, uint16_t Release, uint32_t IncrementalCode = 0,
                        ...
                        4040000 + 100 * steemit::protocol::operation::tag<
                                steemit::protocol::call_order_update_operation<Major, Hardfork, Release>>::value +
                        IncrementalCode, What>;
                ...
                template<uint8_t Major, uint8_t Hardfork, uint16_t Release, uint32_t IncrementalCode = 0,
                        ...
                        4040000 + 100 * steemit::protocol::operation::tag<
                                steemit::protocol::override_transfer_operation<Major, Hardfork, Release>>::value +
                        IncrementalCode, What>;
...
{                                                                          \
    signal( __VA_ARGS__ );                                                  \
            ...
            catch( const steemit::chain::exceptions::chain::plugin<> &e )                         \
{                                                                          \
