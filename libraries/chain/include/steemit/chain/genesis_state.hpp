#ifndef GOLOS_GENESIS_STATE_HPP
#define GOLOS_GENESIS_STATE_HPP
        ...
        struct genesis_state_type {
            struct initial_account_type {
                initial_account_type(const string &name = string(),
                                     ...
                                     bool is_lifetime_member = false) : name(name), owner_key(owner_key), active_key(
                        active_key == public_key_type() ? owner_key : active_key),
            ...
            share_type max_core_supply = STEEMIT_MAX_SHARE_SUPPLY;
            //chain_parameters initial_parameters; TODO: 120
            ...
            uint64_t initial_active_witnesses = STEEMIT_DEFAULT_MIN_WITNESS_COUNT;
