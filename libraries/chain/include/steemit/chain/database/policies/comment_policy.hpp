...
namespace steemit {
    namespace chain {
        ...
        public:
            ...
            void adjust_total_payout(const comment_object &cur, const asset &sbd_created,
            ...
            void update_children_rshares2(const comment_object &c, const fc::uint128_t &old_rshares2,
