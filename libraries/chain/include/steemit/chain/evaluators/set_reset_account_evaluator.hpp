...
namespace steemit {
    namespace chain {
        ...
        class set_reset_account_evaluator : public evaluator_impl<database_t, set_reset_account_evaluator> {
        public:
            typedef protocol::set_reset_account_operation operation_type;

            template<typename Database>
            set_reset_account_evaluator(Database &db) : evaluator_impl<database_t, set_reset_account_evaluator>(db) {
            }
