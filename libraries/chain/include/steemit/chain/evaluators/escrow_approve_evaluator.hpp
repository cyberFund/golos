...
namespace steemit {
    namespace chain {
        ...
        class escrow_approve_evaluator : public evaluator_impl<database_set, escrow_approve_evaluator> {
        public:
            typedef protocol::escrow_approve_operation operation_type;

            template<typename Database>
            escrow_approve_evaluator(Database &db) : evaluator_impl<database_set, escrow_approve_evaluator>(db) {
            }
