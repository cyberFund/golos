...
namespace steemit {
    namespace chain {
        ...
        class delete_comment_evaluator : public evaluator_impl<database_t, delete_comment_evaluator> {
        public:
            typedef protocol::delete_comment_operation operation_type;

            template<typename Database>
            delete_comment_evaluator(Database &db) : evaluator_impl<database_t, delete_comment_evaluator>(db) {
            }
