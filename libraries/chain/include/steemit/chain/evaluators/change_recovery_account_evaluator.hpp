...
namespace steemit {
    namespace chain {
        ...
        class change_recovery_account_evaluator : public evaluator_impl<database_tag,change_recovery_account_evaluator> {
        public:
            typedef protocol::change_recovery_account_operation operation_type;
            template<typename DataBase>
            change_recovery_account_evaluator(DataBase &db) : evaluator_impl<database_tag,change_recovery_account_evaluator>(db) {
            }
