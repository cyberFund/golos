...
namespace steemit {
    namespace chain {
        ...
        class withdraw_vesting_evaluator : public evaluator_impl<database_t, withdraw_vesting_evaluator> {
        public:
            typedef protocol::withdraw_vesting_operation operation_type;

            template<typename Database>
            withdraw_vesting_evaluator(Database &db) : evaluator_impl<database_t, withdraw_vesting_evaluator>(db) {
            }
