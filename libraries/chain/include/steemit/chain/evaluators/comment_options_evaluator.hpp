...
namespace steemit {
    namespace chain {
        ...
        class comment_options_evaluator : public evaluator_impl<database_t, comment_options_evaluator> {
        private:
            struct comment_options_extension_visitor {
                comment_options_extension_visitor(const comment_object &c, database_t &db) : _c(c), _db(db) {
                }
        ...
        public:
            ...
            comment_options_evaluator(Database &db) : evaluator_impl<database_t, comment_options_evaluator>(db) {
            }
