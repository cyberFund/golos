...
namespace steemit {
    ...
    class account_create_evaluator : public steemit::chain::evaluator_impl<account_create_evaluator> {
    public:
        typedef protocol::account_create_operation operation_type;

        account_create_evaluator(database_basic &db) : steemit::chain::evaluator_impl<account_create_evaluator>(db) {
        }

        void do_apply(const protocol::account_create_operation &o);
    };

    class account_create_with_delegation_evaluator : public steemit::chain::evaluator_impl<account_create_with_delegation_evaluator> {
    public:
        typedef protocol::account_create_with_delegation_operation operation_type;

        account_create_with_delegation_evaluator(database_basic &db) : steemit::chain::evaluator_impl<account_create_with_delegation_evaluator>(db) {
        }

        void do_apply(const protocol::account_create_with_delegation_operation &o);
    };

    class account_update_evaluator : public steemit::chain::evaluator_impl<account_update_evaluator> {
    public:
        typedef protocol::account_update_operation operation_type;

        account_update_evaluator(database_basic &db)
    ...
    class transfer_evaluator : public steemit::chain::evaluator_impl<transfer_evaluator> {
    public:
        typedef protocol::transfer_operation operation_type;

        transfer_evaluator(database_basic &db)
    ...
    class transfer_to_vesting_evaluator : public steemit::chain::evaluator_impl<transfer_to_vesting_evaluator> {
    public:
        typedef protocol::transfer_to_vesting_operation operation_type;

        transfer_to_vesting_evaluator(database_basic &db)
    ...
    public:
        ...
        witness_update_evaluator(database_basic &db)
    ...
    public:
        ...
        account_witness_vote_evaluator(database_basic &db)
    ...
    public:
        ...
        account_witness_proxy_evaluator(database_basic &db)
    ...
    public:
        ...
        withdraw_vesting_evaluator(database_basic &db)
    ...
    public:
        ...
        set_withdraw_vesting_route_evaluator(database_basic &db)
    ...
    public:
        ...
        comment_evaluator(database_basic &db)
    ...
    public:
        ...
        comment_options_evaluator(database_basic &db)
    ...
    public:
        ...
        comment_payout_extension_evaluator(database_basic &db)
    ...
    public:
        ...
        delete_comment_evaluator(database_basic &db)
    ...
    public:
        ...
        vote_evaluator(database_basic &db)
    ...
    public:
        ...
        custom_evaluator(database_basic &db)
    ...
    public:
        ...
        custom_json_evaluator(database_basic &db)
    ...
    public:
        ...
        custom_binary_evaluator(database_basic &db)
    ...
    public:
        ...
        pow_evaluator(database_basic &db)
    ...
    public:
        ...
        pow2_evaluator(database_basic &db)
    ...
    public:
        ...
        feed_publish_evaluator(database_basic &db)
    ...
    public:
        ...
        convert_evaluator(database_basic &db)
    ...
    public:
        ...
        limit_order_create_evaluator(database_basic &db)
    ...
    public:
        ...
        limit_order_cancel_evaluator(database_basic &db)
    ...
    public:
        ...
        report_over_production_evaluator(database_basic &db)
    ...
    public:
        ...
        limit_order_create2_evaluator(database_basic &db)
    ...
    public:
        ...
        escrow_transfer_evaluator(database_basic &db)
    ...
    public:
        ...
        escrow_approve_evaluator(database_basic &db)
    ...
    public:
        ...
        escrow_dispute_evaluator(database_basic &db)
    ...
    public:
        ...
        escrow_release_evaluator(database_basic &db)
    ...
    public:
        ...
        challenge_authority_evaluator(database_basic &db)
    ...
    public:
        ...
        prove_authority_evaluator(database_basic &db)
    ...
    public:
        ...
        request_account_recovery_evaluator(database_basic &db)
    ...
    public:
        ...
        recover_account_evaluator(database_basic &db)
    ...
    public:
        ...
        change_recovery_account_evaluator(database_basic &db)
    ...
    public:
        ...
        transfer_to_savings_evaluator(database_basic &db)
    ...
    public:
        ...
        transfer_from_savings_evaluator(database_basic &db)
    ...
    public:
        ...
        cancel_transfer_from_savings_evaluator(database_basic &db)
    ...
    public:
        ...
        decline_voting_rights_evaluator(database_basic &db)
    ...
    public:
        ...
        reset_account_evaluator(database_basic &db)
    ...
    public:
        ...
        set_reset_account_evaluator(database_basic &db)
    ...
    public:
        ...
        delegate_vesting_shares_evaluator(database_basic &db)
