...
namespace steemit {
    namespace chain {
        ...
        class limit_order_create_evaluator
                : public steemit::chain::evaluator<limit_order_create_evaluator> {
        public:
            typedef protocol::limit_order_create_operation operation_type;

            limit_order_create_evaluator(database &db)
                    : steemit::chain::evaluator<limit_order_create_evaluator>(db) {
            }
        ...
        class limit_order_cancel_evaluator
                : public steemit::chain::evaluator<limit_order_cancel_evaluator> {
        public:
            typedef protocol::limit_order_cancel_operation operation_type;

            limit_order_cancel_evaluator(database &db)
                    : steemit::chain::evaluator<limit_order_cancel_evaluator>(db) {
            }
