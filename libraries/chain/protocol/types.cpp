...
namespace fc
{
    ...
    {
        vo = steemit::chain::public_key_type( var.as_string() );
    }
    ...
    {
       vo = steemit::chain::extended_public_key_type( var.as_string() );
    }
    ...
    {
       vo = steemit::chain::extended_private_key_type( var.as_string() );
    }
} // fc
