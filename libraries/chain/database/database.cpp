...
namespace steemit {
    namespace chain {
        ...
        void database::initialize_evaluators() {
            registry.register_evaluator<database_tag, vote_evaluator>(*this);
            registry.register_evaluator<database_tag, transfer_evaluator>(*this);
            registry.register_evaluator<database_tag, transfer_to_vesting_evaluator>(*this);
            registry.register_evaluator<database_tag, withdraw_vesting_evaluator>(*this);
            registry.register_evaluator<database_tag, set_withdraw_vesting_route_evaluator>(*this);
            registry.register_evaluator<database_tag, witness_update_evaluator>(*this);
            registry.register_evaluator<database_tag, account_witness_vote_evaluator>(*this);
            registry.register_evaluator<database_tag, account_witness_proxy_evaluator>(*this);
            registry.register_evaluator<database_tag, custom_evaluator>(*this);
            registry.register_evaluator<database_tag, custom_binary_evaluator>(*this);
            registry.register_evaluator<database_tag, custom_json_evaluator>(*this);
            registry.register_evaluator<database_tag, pow_evaluator>(*this);
            registry.register_evaluator<database_tag, pow2_evaluator>(*this);
            registry.register_evaluator<database_tag, report_over_production_evaluator>(*this);
            registry.register_evaluator<database_tag, feed_publish_evaluator>(*this);
            registry.register_evaluator<database_tag, comment_payout_extension_evaluator>(*this);
            registry.register_evaluator<database_tag, convert_evaluator>(*this);
            registry.register_evaluator<database_tag, challenge_authority_evaluator>(*this);
            registry.register_evaluator<database_tag, prove_authority_evaluator>(*this);
            registry.register_evaluator<database_tag, request_account_recovery_evaluator>(*this);
            registry.register_evaluator<database_tag, recover_account_evaluator>(*this);
            registry.register_evaluator<database_tag, change_recovery_account_evaluator>(*this);
            registry.register_evaluator<database_tag, escrow_transfer_evaluator>(*this);
            registry.register_evaluator<database_tag, escrow_approve_evaluator>(*this);
            registry.register_evaluator<database_tag, escrow_dispute_evaluator>(*this);
            registry.register_evaluator<database_tag, escrow_release_evaluator>(*this);
            registry.register_evaluator<database_tag, transfer_to_savings_evaluator>(*this);
            registry.register_evaluator<database_tag, transfer_from_savings_evaluator>(*this);
            registry.register_evaluator<database_tag, cancel_transfer_from_savings_evaluator>(*this);
            registry.register_evaluator<database_tag, decline_voting_rights_evaluator>(*this);
            registry.register_evaluator<database_tag, reset_account_evaluator>(*this);
            registry.register_evaluator<database_tag, set_reset_account_evaluator>(*this);
            registry.register_evaluator<database_tag, account_create_with_delegation_evaluator>(*this);
            registry.register_evaluator<database_tag, delegate_vesting_shares_evaluator>(*this);
            registry.register_evaluator<database_tag, account_create_evaluator>(*this);
            registry.register_evaluator<database_tag, account_update_evaluator>(*this);
            registry.register_evaluator<database_tag, comment_evaluator>(*this);
            registry.register_evaluator<database_tag, comment_options_evaluator>(*this);
            registry.register_evaluator<database_tag, delete_comment_evaluator>(*this);
            registry.register_evaluator<database_tag, limit_order_create_evaluator>(*this);
            registry.register_evaluator<database_tag, limit_order_create2_evaluator>(*this);
            registry.register_evaluator<database_tag, limit_order_cancel_evaluator>(*this);
        }
