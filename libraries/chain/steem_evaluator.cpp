...
namespace steemit {
    namespace chain {
        ...
        void witness_update_evaluator::do_apply(const witness_update_operation &o) {
            ...
            const auto &by_witness_name_idx = this->db.get_index<witness_index>().indices().get<by_name>();
            ...
            if (wit_itr != by_witness_name_idx.end()) {
                ...
                this->db.create<witness_object>([&](witness_object &w) {
                    w.owner = o.owner;
                    from_string(w.url, o.url);
                    w.signing_key = o.block_signing_key;
 ...
 */
        void delete_comment_evaluator::do_apply(const delete_comment_operation &o) {
            ...
            const auto &vote_idx = this->db.get_index<comment_vote_index>().indices().get<by_comment_voter>();
            ...
            if (this->db.has_hardfork(STEEMIT_HARDFORK_0_6__80) &&
        ...
        void comment_payout_extension_evaluator::do_apply(const comment_payout_extension_operation &o) {
            ...
            if (o.amount) {
                ...
                asset amount = this->db.get_payout_extension_cost(comment, *o.extension_time);
        ...
        void comment_evaluator::do_apply(const comment_operation &o) {
            try {
                if (this->db.is_producing() ||
                    this->db.has_hardfork(STEEMIT_HARDFORK_0_5__55)) {
                    FC_ASSERT(o.title.size() + o.body.size() +
                              o.json_metadata.size(), "Cannot update comment because nothing appears to be changing.");
                }

                const auto &by_permlink_idx = this->db.get_index<comment_index>().indices().get<by_permlink>();
                ...
                if ((this->db.is_producing() ||
                     this->db.has_hardfork(STEEMIT_HARDFORK_0_17)) &&
                ...
                if (itr == by_permlink_idx.end()) {
                    if (o.parent_author != STEEMIT_ROOT_POST_PARENT) {
                        FC_ASSERT(this->db.get(parent->root_comment).allow_replies, "The parent comment has disabled replies.");
                        if (this->db.has_hardfork(STEEMIT_HARDFORK_0_12__177) &&
                            !this->db.has_hardfork(STEEMIT_HARDFORK_0_17__97)) {
                            FC_ASSERT(
                                    this->db.calculate_discussion_payout_time(*parent) !=
                                    fc::time_point_sec::maximum(), "Discussion is frozen.");
                        }
                    }

                    auto band = this->db.find<account_bandwidth_object, by_account_bandwidth_type>(boost::make_tuple(o.author, bandwidth_type::post));

                    if (band == nullptr) {
                        band = &this->db.create<account_bandwidth_object>([&](account_bandwidth_object &b) {
                            b.account = o.author;
                    ...
                    const auto &new_comment = this->db.create<comment_object>([&](comment_object &com) {
                        if (this->db.has_hardfork(STEEMIT_HARDFORK_0_1)) {
                    ...
                    if (!cat) {
                        cat = &this->db.create<category_object>([&](category_object &c) {
...
/// this loop can be skiped for validate-only nodes as it is merely gathering stats for indicies
        ...
        void escrow_transfer_evaluator::do_apply(const escrow_transfer_operation &o) {
            try {
                ...
                FC_ASSERT(o.ratification_deadline >
                          this->db.head_block_time(), "The escrow ratification deadline must be after head block time.");
                FC_ASSERT(o.escrow_expiration >
                          this->db.head_block_time(), "The escrow expiration must be after head block time.");
        ...
        void escrow_approve_evaluator::do_apply(const escrow_approve_operation &o) {
            try {
                ...
                FC_ASSERT(escrow.ratification_deadline >=
                          this->db.head_block_time(), "The escrow ratification deadline has passed. Escrow can no longer be ratified.");
        ...
        void withdraw_vesting_evaluator::do_apply(const withdraw_vesting_operation &o) {
            ...
            if (!account.mined &&
                this->db.has_hardfork(STEEMIT_HARDFORK_0_1)) {
                ...
                FC_ASSERT(account.vesting_shares > min_vests ||
                          (this->db.has_hardfork(STEEMIT_HARDFORK_0_16__562) &&
            ...
            if (o.vesting_shares.amount == 0) {
                if (this->db.is_producing() ||
                    this->db.has_hardfork(STEEMIT_HARDFORK_0_5__57)) {
                ...
                this->db.modify(account, [&](account_object &a) {
                    ...
                    a.next_vesting_withdrawal = this->db.head_block_time() +
        ...
        void set_withdraw_vesting_route_evaluator::do_apply(const set_withdraw_vesting_route_operation &o) {
            try {
                ...
                const auto &wd_idx = this->db.get_index<withdraw_vesting_route_index>().indices().get<by_withdraw_route>();
                ...
                if (itr == wd_idx.end()) {
                    ...
                    this->db.create<withdraw_vesting_route_object>([&](withdraw_vesting_route_object &wvdo) {
        ...
        void account_witness_vote_evaluator::do_apply(const account_witness_vote_operation &o) {
            ...
            const auto &by_account_witness_idx = this->db.get_index<witness_vote_index>().indices().get<by_account_witness>();
            ...
            if (itr == by_account_witness_idx.end()) {
                ...
                if (this->db.has_hardfork(STEEMIT_HARDFORK_0_2)) {
                    ...
                    this->db.create<witness_vote_object>([&](witness_vote_object &v) {
        ...
        void vote_evaluator::do_apply(const vote_operation &o) {
            try {
                ...
                int64_t elapsed_seconds = (this->db.head_block_time() -
                ...
                if (itr != comment_vote_idx.end() && itr->num_changes == -1) {
                    if (this->db.is_producing() ||
                        this->db.has_hardfork(STEEMIT_HARDFORK_0_12__177)) {
                ...
                if (itr == comment_vote_idx.end()) {
                    ...
                    if (rshares > 0 &&
                        this->db.has_hardfork(STEEMIT_HARDFORK_0_7)) {
                        if (this->db.has_hardfork(STEEMIT_HARDFORK_0_17__91)) {
                            FC_ASSERT(this->db.head_block_time() <
                    ...
                    if (!this->db.has_hardfork(STEEMIT_HARDFORK_0_17__91)) {
                        ...
                        if (this->db.has_hardfork(STEEMIT_HARDFORK_0_12__177) &&
                            ...
                            new_cashout_time_sec =
                                    this->db.head_block_time().sec_since_epoch() +
                                    STEEMIT_CASHOUT_WINDOW_SECONDS_PRE_HF17;
                        } else {
                            new_cashout_time_sec =
                                    this->db.head_block_time().sec_since_epoch() +
                    ...
                    this->db.modify(comment, [&](comment_object &c) {
                        ...
                        if (!this->db.has_hardfork(STEEMIT_HARDFORK_0_6__114) &&
                     ...
                     *
      **/
                    this->db.create<comment_vote_object>([&](comment_vote_object &cv) {
                        cv.voter = voter.id;
                        ...
                        if (curation_reward_eligible &&
                            this->db.has_hardfork(STEEMIT_HARDFORK_0_17__86)) {
                            curation_reward_eligible =
                                    this->db.get_curation_rewards_percent(comment) >
                                    0;
                        }
                    ...
                    if (this->db.is_producing() ||
                        this->db.has_hardfork(STEEMIT_HARDFORK_0_6__112)) {
        ...
        void request_account_recovery_evaluator::do_apply(const request_account_recovery_operation &o) {
            ...
            if (account_to_recover.recovery_account.length()) {   // Make sure recovery matches expected recovery account
                ...
                FC_ASSERT(
                        this->db.get_index<witness_index>().indices().get<by_vote_name>().begin()->owner ==
                        o.recovery_account, "Top witness must recover an account with no recovery partner.");
            }

            const auto &recovery_request_idx = this->db.get_index<account_recovery_request_index>().indices().get<by_account>();
        ...
        void recover_account_evaluator::do_apply(const recover_account_operation &o) {
            ...
            const auto &recent_auth_idx = this->db.get_index<owner_authority_history_index>().indices().get<by_account>();
        ...
        void change_recovery_account_evaluator::do_apply(const change_recovery_account_operation &o) {
            ...
            const auto &change_recovery_idx = this->db.get_index<change_recovery_account_request_index>().indices().get<by_account>();
            auto request = change_recovery_idx.find(o.account_to_recover);

            if (request == change_recovery_idx.end()) // New request
            {
                this->db.create<change_recovery_account_request_object>([&](change_recovery_account_request_object &req) {
                    req.account_to_recover = o.account_to_recover;
                    req.recovery_account = o.new_recovery_account;
                    req.effective_on = this->db.head_block_time() +
        ...
        void decline_voting_rights_evaluator::do_apply(const decline_voting_rights_operation &o) {
            ...
            const auto &account = this->db.get_account(o.account);
            const auto &request_idx = this->db.get_index<decline_voting_rights_request_index>().indices().get<by_account>();
            ...
            if (o.decline) {
                ...
                this->db.create<decline_voting_rights_request_object>([&](decline_voting_rights_request_object &req) {
                    req.account = account.id;
                    req.effective_date = this->db.head_block_time() +
                                         STEEMIT_OWNER_AUTH_RECOVERY_PERIOD;
                });
            } else {
                FC_ASSERT(itr !=
        ...
        void reset_account_evaluator::do_apply(const reset_account_operation &op) {
            ...
            auto band = this->db.find<account_bandwidth_object, by_account_bandwidth_type>(boost::make_tuple(op.account_to_reset, bandwidth_type::old_forum));
            if (band != nullptr) {
                FC_ASSERT(
                        (this->db.head_block_time() -
        ...
        void delegate_vesting_shares_evaluator::do_apply(const delegate_vesting_shares_operation &op) {
            ...
            FC_ASSERT(this->db.has_hardfork(STEEMIT_HARDFORK_0_17__101), "delegate_vesting_shares_operation is not enabled until HF 17"); //TODO: Delete after hardfork

            const auto &delegator = this->db.get_account(op.delegator);
            const auto &delegatee = this->db.get_account(op.delegatee);
            auto delegation = this->db.find<vesting_delegation_object, by_delegation>(boost::make_tuple(op.delegator, op.delegatee));
            ...
            if (delegation == nullptr) {
                ...
                this->db.create<vesting_delegation_object>([&](vesting_delegation_object &obj) {
                ...
                this->db.create<vesting_delegation_expiration_object>([&](vesting_delegation_expiration_object &obj) {
                    obj.delegator = op.delegator;
                    obj.vesting_shares = delta;
                    obj.expiration = std::max(this->db.head_block_time() +
