...
void steemit::chain::comment_evaluator::do_apply(const protocol::comment_operation &o) {
    try {
        if (this->_db.is_producing() || this->_db.has_hardfork(STEEMIT_HARDFORK_0_5__55)) {
        ...
        if ((this->_db.is_producing() || this->_db.has_hardfork(STEEMIT_HARDFORK_0_17)) && o.json_metadata.size())
        ...
        if (itr == by_permlink_idx.end()) {
            if (o.parent_author != STEEMIT_ROOT_POST_PARENT) {
                ...
                if (this->_db.has_hardfork(STEEMIT_HARDFORK_0_12__177) &&
                    ...
                    FC_ASSERT(this->_db.calculate_discussion_payout_time(*parent) != fc::time_point_sec::maximum(),
            ...
            if (o.parent_author == STEEMIT_ROOT_POST_PARENT) {
                ...
                if (this->_db.has_hardfork(STEEMIT_HARDFORK_0_17__78)) {
                    ...
                    auto old_weight = (post_bandwidth * (STEEMIT_POST_AVERAGE_WINDOW - post_delta_time)) /
                                      STEEMIT_POST_AVERAGE_WINDOW;
                    post_bandwidth = (old_weight + STEEMIT_100_PERCENT);
                    reward_weight = uint16_t(std::min((STEEMIT_POST_WEIGHT_CONSTANT_PRE_HF17 * STEEMIT_100_PERCENT) /
                                                      (post_bandwidth.value * post_bandwidth.value),
                                                      uint64_t(STEEMIT_100_PERCENT)));
                }
            ...
            const auto &new_comment = this->_db.create<comment_object>([&](comment_object &com) {
                ...
                if (o.parent_author == STEEMIT_ROOT_POST_PARENT) {
                    ...
                    com.cashout_time = this->_db.has_hardfork(STEEMIT_HARDFORK_0_12__177) ?
                                       this->_db.head_block_time() + STEEMIT_CASHOUT_WINDOW_SECONDS_PRE_HF17
        ...
        } else // start edit case
        {
            ...
            if (this->_db.has_hardfork(STEEMIT_HARDFORK_0_17__85)) {
                ...
                if (this->_db.is_producing()) {
                    ...
                    FC_ASSERT(this->_db.calculate_discussion_payout_time(comment) != fc::time_point_sec::maximum(),
