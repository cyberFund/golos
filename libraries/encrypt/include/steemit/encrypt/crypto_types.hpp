...
#define STEEMIT_SECTORS 100


#define SHORT_CURVE 1
#ifdef SHORT_CURVE
#define STEEMIT_SIZE_OF_POINT_ON_CURVE_COMPRESSED 33
#define STEEMIT_SIZE_OF_MU 15
#else
#define STEEMIT_SIZE_OF_POINT_ON_CURVE_COMPRESSED 65
#define STEEMIT_SIZE_OF_MU 32
#endif
...
namespace steemit {
    namespace encrypt {
        ...
        public:
            ...
            DIntegerString(const std::string &_s) {
                s = _s;
            };

            /* copy constructor */
            DIntegerString(DIntegerString &_s) {
                s = _s.s;
            };

            /* copy constructor */
            DIntegerString(const DIntegerString &_s) {
                s = _s.s;
            };
            ...
            DIntegerString &operator=(const std::string &_s) {
                s = _s;
                return *this;
            };
            ...
            /* Comparision operator */
            DIntegerString &operator=(const DIntegerString &_s) {
                s = _s.s;
                return *this;
            };
        };
        ...
        public:
            ...
            static DInteger from_string(DIntegerString from) {
                return from_string(from.s);
            };
            ...
            DInteger(const DIntegerString &s) : CryptoPP::Integer(
                    from_string(s.s)) {
            };

            DInteger &operator=(const DInteger &integer) {
                CryptoPP::Integer::operator=(integer);
                return *this;
            };
            ...
            DInteger &operator=(const DIntegerString &s) {
                *this = DInteger::from_string(s.s);
                return *this;
            };
        };
        ...
        struct DeliveryProofString {
            ...
            DeliveryProofString(DInteger g1, DInteger g2, DInteger g3, DInteger s, DInteger r)
                    : G1(g1), G2(g2), G3(g3), s(s), r(r) {
            };
        ...
        struct DeliveryProof {
            ...
            DeliveryProof(DInteger g1, DInteger g2, DInteger g3, DInteger s, DInteger r)
                    : G1(g1), G2(g2), G3(g3), s(s), r(r) {
            };
        ...
        struct CustodyData {
            ...
            fc::array<uint8_t, STEEMIT_SIZE_OF_POINT_ON_CURVE_COMPRESSED> pubKey; //<uploaders public key

            bool operator==(const CustodyData &other) const {
                return n == other.n && u_seed == other.u_seed &&
                       pubKey == other.pubKey;
            }
        };
        ...
        struct CustodyProof {
            ...
            fc::array<uint8_t, STEEMIT_SIZE_OF_POINT_ON_CURVE_COMPRESSED> sigma; //<sigma
        };
        ...
        struct Ciphertext {
            ...
            Ciphertext(CiphertextString &s) {
                C1 = DInteger::from_string(s.C1.s);
                D1 = DInteger::from_string(s.D1.s);
            };

            Ciphertext(const CiphertextString &s) {
                C1 = DInteger::from_string(s.C1.s);
                D1 = DInteger::from_string(s.D1.s);
            };
