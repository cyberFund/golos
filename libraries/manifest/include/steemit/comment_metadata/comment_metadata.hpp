...
/**
 *  The purpose of this metaobject is to allow the generation and listing of
 ...
 */
        ...
        class comment_meta_data_object
                : public object<TypeNumber, comment_meta_data_object<TypeNumber>> {
        public:
            template<typename Constructor, typename Allocator>
            comment_meta_data_object(Constructor &&c, allocator<Allocator> a)
                    : name(""),
                      net_rshares(0),
                      net_votes(0),
                      children(0),
            ...
            typename comment_meta_data_object<TypeNumber>::id_type id;
        ...
        template<uint16_t TypeNumber>
        class by_cashout
                : public comparable_index<comment_meta_data_object<TypeNumber>> {
        public:
            virtual bool
 ...
 */
        ...
        class peer_stats_object
                : public object<TypeNumber, peer_stats_object<TypeNumber>> {
        public:
            template<typename Constructor, typename Allocator>
            ...
            typename peer_stats_object<TypeNumber>::id_type id;
