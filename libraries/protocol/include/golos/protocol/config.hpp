...
#define STEEMIT_MAX_WITNESS_VOTE_AGE    (fc::seconds(30*60))
...
#define STEEMIT_DEFAULT_PRODUCER_REWARD_DURATION               90
...
#define STEEMIT_DELEGATION_MIN_THRESHOLD           10
...
#define STEEMIT_MIN_LIQUIDITY_REWARD            golos::protocol::asset<0, 17, 0>(1000*STEEMIT_LIQUIDITY_REWARD_BLOCKS, STEEM_SYMBOL_NAME) // Minumum reward to be paid out to liquidity providers
#define STEEMIT_MIN_CONTENT_REWARD              golos::protocol::asset<0, 17, 0>(1500, STEEM_SYMBOL_NAME)
#define STEEMIT_MIN_CURATE_REWARD               golos::protocol::asset<0, 17, 0>(500, STEEM_SYMBOL_NAME)
...
#define STEEMIT_ACTIVE_CHALLENGE_FEE            golos::protocol::asset<0, 17, 0>(2000, STEEM_SYMBOL_NAME)
#define STEEMIT_OWNER_CHALLENGE_FEE             golos::protocol::asset<0, 17, 0>(30000, STEEM_SYMBOL_NAME)
...
#define STEEMIT_MIN_PAYOUT_SBD                  golos::protocol::asset<0, 17, 0>(20,SBD_SYMBOL_NAME)
...
#define STEEMIT_MAX_FEED_AGE                    (60*60*24*7)
...
#define STEEMIT_MIN_ASSET_CREATION_FEE             1
...
#define STEEMIT_MAX_WITNESS_VOTE_AGE (fc::days(90))
#define STEEMIT_MAX_TIME_UNTIL_EXPIRATION       (60*60) // seconds,  aka: 1 hour
#define STEEMIT_MAX_MEMO_SIZE                   2048
#define STEEMIT_MAX_PROXY_RECURSION_DEPTH       4
#define STEEMIT_VESTING_WITHDRAW_INTERVALS_PRE_HF16 104
