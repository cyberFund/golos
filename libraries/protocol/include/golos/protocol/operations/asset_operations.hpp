...
FC_REFLECT((golos::protocol::asset_create_operation<0, 17, 0>),
           (issuer)(asset_name)(precision)(common_options)(bitasset_opts)(is_prediction_market)(extensions))
FC_REFLECT((golos::protocol::asset_update_operation<0, 17, 0>),
           (issuer)(asset_to_update)(new_issuer)(new_options)(extensions))
FC_REFLECT((golos::protocol::asset_update_bitasset_operation<0, 17, 0>),
