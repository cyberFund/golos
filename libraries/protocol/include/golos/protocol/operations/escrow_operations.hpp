...
namespace golos {
    namespace protocol {
         ...
         *  @ingroup operations
         *
         *  @brief The purpose of this operation is to enable someone to send money contingently to
         *  another individual.
         *
         *  The funds leave the *from* account and go into a temporary balance
