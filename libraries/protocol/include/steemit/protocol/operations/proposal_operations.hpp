...
FC_REFLECT(typename BOOST_IDENTITY_TYPE((steemit::protocol::proposal_create_operation<0, 17, 0>)),
           (owner)(proposal_id)(expiration_time)(proposed_operations)(review_period_seconds)(extensions))

FC_REFLECT(typename BOOST_IDENTITY_TYPE((steemit::protocol::proposal_update_operation<0, 17, 0>)),
...
FC_REFLECT(typename BOOST_IDENTITY_TYPE((steemit::protocol::proposal_delete_operation<0, 17, 0>)), (owner)(using_owner_authority)(proposal_id)(extensions))
