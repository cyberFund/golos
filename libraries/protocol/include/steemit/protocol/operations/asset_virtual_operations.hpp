...
FC_REFLECT(typename BOOST_IDENTITY_TYPE((steemit::protocol::asset_settle_cancel_operation<0, 16, 0>)), (settlement)(account)(amount)(extensions))
FC_REFLECT(typename BOOST_IDENTITY_TYPE((steemit::protocol::asset_settle_cancel_operation<0, 17, 0>)), (settlement)(account)(amount)(extensions))
