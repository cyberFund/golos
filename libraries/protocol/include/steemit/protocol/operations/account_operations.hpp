...
FC_REFLECT(typename BOOST_IDENTITY_TYPE((steemit::protocol::account_create_operation<0, 16, 0>)),
           (fee)(creator)(new_account_name)(owner)(active)(posting)(memo_key)(json_metadata))
FC_REFLECT(typename BOOST_IDENTITY_TYPE((steemit::protocol::account_create_operation<0, 17, 0>)),
           (fee)(creator)(new_account_name)(owner)(active)(posting)(memo_key)(json_metadata))
...
FC_REFLECT(typename BOOST_IDENTITY_TYPE((steemit::protocol::account_whitelist_operation<0, 17, 0>)),
           (fee)(authorizing_account)(account_to_list)(new_listing)(extensions))
