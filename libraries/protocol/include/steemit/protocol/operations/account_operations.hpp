...
FC_REFLECT(steemit::protocol::account_update_operation, (account)(owner)(active)(posting)(memo_key)(json_metadata))

FC_REFLECT_ENUM(steemit::protocol::account_whitelist_operation::account_listing,
                (no_listing)(white_listed)(black_listed)(white_and_black_listed));
FC_REFLECT(steemit::protocol::account_whitelist_operation,
