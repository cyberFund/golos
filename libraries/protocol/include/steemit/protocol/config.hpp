...
#define STEEMIT_MINING_REWARD                   asset( 666, STEEM_SYMBOL_NAME )
#define STEEMIT_MINING_REWARD_PRE_HF16          asset( 1000, STEEM_SYMBOL_NAME )
...
#define STEEMIT_MIN_LIQUIDITY_REWARD            (asset( 1000*STEEMIT_LIQUIDITY_REWARD_BLOCKS, STEEM_SYMBOL_NAME )) // Minumum reward to be paid out to liquidity providers
#define STEEMIT_MIN_CONTENT_REWARD              asset( 1500, STEEM_SYMBOL_NAME )
#define STEEMIT_MIN_CURATE_REWARD               asset( 500, STEEM_SYMBOL_NAME )
...
#define STEEMIT_ACTIVE_CHALLENGE_FEE            asset( 2000, STEEM_SYMBOL_NAME )
#define STEEMIT_OWNER_CHALLENGE_FEE             asset( 30000, STEEM_SYMBOL_NAME )
...
#define STEEMIT_MIN_PAYOUT_SBD                  (asset(20,SBD_SYMBOL_NAME))
