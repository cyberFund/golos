...
#define STEEMIT_MINING_REWARD                   {666, STEEM_SYMBOL_NAME}
#define STEEMIT_MINING_REWARD_PRE_HF16          {1000, STEEM_SYMBOL_NAME}
...
#define STEEMIT_MIN_LIQUIDITY_REWARD            ({1000*STEEMIT_LIQUIDITY_REWARD_BLOCKS, STEEM_SYMBOL_NAME}) // Minumum reward to be paid out to liquidity providers
#define STEEMIT_MIN_CONTENT_REWARD              {1500, STEEM_SYMBOL_NAME}
#define STEEMIT_MIN_CURATE_REWARD               {500, STEEM_SYMBOL_NAME}
...
#define STEEMIT_ACTIVE_CHALLENGE_FEE            {2000, STEEM_SYMBOL_NAME}
#define STEEMIT_OWNER_CHALLENGE_FEE             {30000, STEEM_SYMBOL_NAME}
