    ...
    namespace witness_plugin {
        ...
        void witness_plugin::plugin_set_program_options(
            ...
            command_line_options.add_options()("enable-stale-production",
                    ...
                    ("name of witness controlled by this node (e.g. " + witness_id_example + " )").c_str())("miner,m",
                                                                                                            boost::program_options::value<
                                                                                                                    std::vector<
                                                                                                                            std::string>>()->composing()->multitoken(),
                                                                                                            "name of miner and its private key (e.g. [\"account\",\"WIF PRIVATE KEY\"] )")(
                    "mining-threads,t", boost::program_options::value<uint32_t>(),
                    "Number of threads to use for proof of work mining")("private-key", boost::program_options::value<
        ...
        void witness_plugin::plugin_startup() {
            try {
                ...
                if (!_miners.empty()) {
                    ...
                    d.applied_block.connect([this](const protocol::signed_block &b) {
        ...
        block_production_condition::block_production_condition_enum witness_plugin::maybe_produce_block(
            ...
            do {
                try {
                    ...
                    fc::async([this, block]() {
                        p2p_node().broadcast(network::block_message(block));
                    });
