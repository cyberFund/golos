...
namespace golos {
    namespace account_statistics {
        ...
        enum account_statistics_plugin_object_types {
            ...
            (ACCOUNT_STATISTICS_SPACE_ID << 8) + 1
        };
        ...
        class account_statistics_plugin : public golos::application::plugin {
        public:
...
FC_REFLECT((golos::account_statistics::account_stats_bucket_object),
        (id)
                (open)
                (seconds)
                (name)
...
//SET_INDEX_TYPE( golos::account_statistics::account_stats_bucket_object,)

FC_REFLECT((golos::account_statistics::account_activity_bucket_object), (id)
                (open)
                (seconds)
