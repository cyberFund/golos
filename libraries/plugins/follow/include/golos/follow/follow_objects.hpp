 ...
 */
        class blog_author_stats_object
                : public object<blog_author_stats_object_type, blog_author_stats_object> {
        public:
            template<typename Constructor, typename Allocator>
        ...
        class reputation_object
                : public object<reputation_object_type, reputation_object> {
        public:
            template<typename Constructor, typename Allocator>
        ...
        class follow_count_object
                : public object<follow_count_object_type, follow_count_object> {
        public:
            template<typename Constructor, typename Allocator>
...
FC_REFLECT_ENUM(golos::follow::follow_type, (undefined)(blog)(ignore))

FC_REFLECT((golos::follow::follow_object), (id)(follower)(following)(what))
CHAINBASE_SET_INDEX_TYPE(golos::follow::follow_object, golos::follow::follow_index)

FC_REFLECT((golos::follow::feed_object), (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(reblogs)(account_feed_id))
CHAINBASE_SET_INDEX_TYPE(golos::follow::feed_object, golos::follow::feed_index)

FC_REFLECT((golos::follow::blog_object), (id)(account)(comment)(reblogged_on)(blog_feed_id))
CHAINBASE_SET_INDEX_TYPE(golos::follow::blog_object, golos::follow::blog_index)

FC_REFLECT((golos::follow::reputation_object), (id)(account)(reputation))
CHAINBASE_SET_INDEX_TYPE(golos::follow::reputation_object, golos::follow::reputation_index)

FC_REFLECT((golos::follow::follow_count_object), (id)(account)(follower_count)(following_count))
CHAINBASE_SET_INDEX_TYPE(golos::follow::follow_count_object, golos::follow::follow_count_index)

FC_REFLECT((golos::follow::blog_author_stats_object), (id)(blogger)(guest)(count))
CHAINBASE_SET_INDEX_TYPE(golos::follow::blog_author_stats_object, golos::follow::blog_author_stats_index);
