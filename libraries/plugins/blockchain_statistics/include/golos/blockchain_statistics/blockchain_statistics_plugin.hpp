...
namespace golos {
    namespace blockchain_statistics {
        ...
        class blockchain_statistics_plugin : public golos::application::plugin {
        public:
        ...
        struct bucket_object : public object<bucket_object_type, bucket_object> {
            ...
            share_type sbd_paid_to_authors = 0;                   ///< Amount of SBD paid to authors
            share_type vests_paid_to_authors = 0;                 ///< Amount of VESS paid to authors
            share_type vests_paid_to_curators = 0;                ///< Amount of VESTS paid to curators
            share_type liquidity_rewards_paid = 0;                ///< Amount of STEEM paid to market makers
            uint32_t transfers_to_vesting = 0;                    ///< Transfers of STEEM into VESTS
            share_type steem_vested = 0;                          ///< Amount of STEEM vested
            ...
            share_type vests_withdrawn = 0;                       ///< Amount of VESTS withdrawn to STEEM
            share_type vests_transferred = 0;                     ///< Amount of VESTS transferred to another account
...
FC_REFLECT((golos::blockchain_statistics::bucket_object),
...
CHAINBASE_SET_INDEX_TYPE(golos::blockchain_statistics::bucket_object, golos::blockchain_statistics::bucket_index)
