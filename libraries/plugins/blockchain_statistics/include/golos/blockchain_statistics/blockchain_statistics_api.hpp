...
#include <golos/blockchain_statistics/blockchain_statistics_plugin.hpp>
...
FC_REFLECT((golos::blockchain_statistics::statistics),
        (blocks)
                (bandwidth)
                (operations)
                (transactions)
...
FC_API(golos::blockchain_statistics::blockchain_statistics_api,
        (get_stats_for_time)
