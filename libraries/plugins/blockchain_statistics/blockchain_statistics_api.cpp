...
namespace steemit {
    namespace blockchain_statistics {
            ...
            statistics blockchain_statistics_api::blockchain_statistics_api_impl::get_stats_for_interval(fc::time_point_sec start, fc::time_point_sec end) const {
                statistics result;
        ...
        statistics &statistics::operator+=(const bucket_object &b) {
            ...
            this->accounts_created +=
                    b.paid_accounts_created + b.mined_accounts_created;
            ...
            this->total_comments_deleted +=
                    b.root_comments_deleted + b.replies_deleted;
            ...
            this->total_votes += b.new_root_votes + b.changed_root_votes +
                                 b.new_reply_votes + b.changed_reply_votes;
