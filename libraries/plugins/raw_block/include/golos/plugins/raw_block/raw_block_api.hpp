...
namespace golos {
    namespace plugin {
        namespace raw_block {
            ...
            class raw_block_api {
            public:
                raw_block_api(const golos::application::api_context &ctx);
...
FC_REFLECT((golos::plugin::raw_block::get_raw_block_args),
        (block_num)
)

FC_REFLECT((golos::plugin::raw_block::get_raw_block_result),
        (block_id)
                (previous)
                (timestamp)
                (raw_block)
...
FC_API(golos::plugin::raw_block::raw_block_api,
        (get_raw_block)
                (push_raw_block)
)
