...
#define LANGUAGES_PLUGIN_NAME "languages"
         ...
         *
         */
        class languages_plugin : public golos::application::plugin {
        public:
            ...
            static bool filter(const golos::application::discussion_query &query,
                               ...
                               const std::function<bool(const golos::application::comment_api_object &)> &confition);
        ...
        public:
            ...
            language_api(const golos::application::api_context &ctx);
...
FC_REFLECT((golos::languages::comment_metadata), (language));

FC_API(golos::languages::language_api, (get_languages));

FC_REFLECT((golos::languages::language_object),
...
CHAINBASE_SET_INDEX_TYPE(golos::languages::language_object, golos::languages::language_index)

FC_REFLECT((golos::languages::language_stats_object),
           (id)(language)(total_children_rshares2)(total_payout)(net_votes)(top_posts)(comments));
CHAINBASE_SET_INDEX_TYPE(golos::languages::language_stats_object, golos::languages::language_stats_index)

FC_REFLECT((golos::languages::peer_stats_object),
