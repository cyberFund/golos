...
FC_REFLECT((golos::plugin::debug_node::get_dev_key_args),
        (name)
)

FC_REFLECT((golos::plugin::debug_node::get_dev_key_result),
        (private_key)
                (public_key)
)

FC_REFLECT((golos::plugin::debug_node::debug_mine_args),
        (worker_account)
                (props)
)

FC_REFLECT((golos::plugin::debug_node::debug_mine_result), )

FC_API(golos::plugin::debug_node::debug_node_api,
        (debug_push_blocks)
