    ...
    namespace plugin {
        namespace debug_node {
            ...
            public:
                ...
                void debug_update(Lambda &&callback, uint32_t skip = static_cast<uint32_t >(chain::validation_steps::skip_nothing)) {
                ...
                uint32_t debug_generate_blocks(
                        ...
                        uint32_t count,
                        uint32_t skip = static_cast<uint32_t>(chain::validation_steps::skip_nothing),
