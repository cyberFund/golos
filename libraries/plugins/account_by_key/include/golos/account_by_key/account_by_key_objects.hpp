...
FC_REFLECT((golos::account_by_key::key_lookup_object), (id)(key)(account))
CHAINBASE_SET_INDEX_TYPE(golos::account_by_key::key_lookup_object, golos::account_by_key::key_lookup_index)
