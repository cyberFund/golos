...
namespace golos {
    namespace wallet {
        ...
        class api_documentation {
            typedef boost::multi_index::multi_index_container<method_description, boost::multi_index::indexed_by<
                    boost::multi_index::ordered_unique<boost::multi_index::member<method_description, std::string,
                            &method_description::method_name>>>> method_description_set;
        ...
        public:
            ...
            std::string get_brief_description(const std::string &method_name) const {
                ...
                if (iter != method_descriptions.end()) {
                    ...
                    FC_THROW_EXCEPTION(fc::key_not_found_exception, "No entry for method ${name}",
                                       ("name", method_name));
            }
