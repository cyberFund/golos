 ...
 */
        ...
        annotated_signed_transaction wallet_api::post_comment(string author, string permlink, string parent_author, string parent_permlink,string languages,string title, string body, string json, bool broadcast) {
            FC_ASSERT(!is_locked());
