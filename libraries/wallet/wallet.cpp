        ...
        namespace detail {
            ...
            public:
                ...
                annotated_signed_transaction create_first_key_value_object(string system, fc::uint128_t block_number,
                    ...
                    try {
                        key_value::create_first_key_value_operation operation;
                ...
                optional<fc::api<key_value::key_value_api>> _remote_key_value_api;
...
namespace steemit {
    namespace wallet {
        ...
        annotated_signed_transaction wallet_api::create_first_key_value_object(string system,
            ...
            return my->create_first_key_value_object(system, block_number, block_hash, ipfs_hash_link, block_timestamp,
