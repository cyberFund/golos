...
templates = {
    ...
    "include/{plugin_provider}/plugins/{plugin_name}/{plugin_name}_api.hpp":
        ...
        {{
           public:
              {plugin_name}_api( const golos::application::api_context& ctx );
    ...
    "include/{plugin_provider}/plugins/{plugin_name}/{plugin_name}_plugin.hpp":
        ...
        class {plugin_name}_plugin : public golos::application::plugin
        {{
           public:
              {plugin_name}_plugin( golos::application::application* app );
    ...
    "{plugin_name}_api.cpp":
        ...
        {{
           public:
              {plugin_name}_api_impl( golos::application::application& _app );
        ...
        {plugin_name}_api_impl::{plugin_name}_api_impl( golos::application::application& _app ) : app( _app )
        {{}}
        ...
        {plugin_name}_api::{plugin_name}_api( const golos::application::api_context& ctx )
        {{
    ...
    "{plugin_name}_plugin.cpp":
        ...
        {{
           public:
              {plugin_name}_plugin_impl( golos::application::application& app );
        ...
        {plugin_name}_plugin_impl::{plugin_name}_plugin_impl( golos::application::application& app )
          : _app(app) {{}}
        ...
        {plugin_name}_plugin::{plugin_name}_plugin( golos::application::application* app )
           : plugin(app)
        {{
