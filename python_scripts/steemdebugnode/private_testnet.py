...
def main():
    ...
    parser.add_argument('--apis', '-a', type=str, required=False,
                        help='A list of apis to load. database_api, login_api, ' + \
    ...
    debug_node = DebugNode(str(steemd), str(data_dir), plugins=plugins, apis=apis, args='--replay',
